 ...
 * Meetings, Review, Today, Journal, and Notes use the wider desktop surface
 * needed for dense lists, table/editing controls, the task picker, two-column
 * notes + tasks layouts, and a comfortably wide entry textarea.
 */
